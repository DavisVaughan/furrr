future_map_template <- function(.map, .type, .x, .f, ..., .options) {
  ...
  globals_extra <- future::as.FutureGlobals(list(...future.x_ii = NULL, ...future.seeds_ii = NULL))
  ...
  ...future.map <- ...future.f <- ...future.x_ii <- ...future.seeds_ii <- temp_file <- NULL
