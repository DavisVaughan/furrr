#' @rdname future_map
#' @export
future_walk <- function(.x, .f, ..., .options = future_options()) {
...
#' @rdname future_map2
#' @export
future_walk2 <- function(.x, .y, .f, ..., .options = future_options()) {
...
#' @rdname future_map2
#' @export
future_pwalk <- function(.l, .f, ..., .options = future_options()) {
...
#' @rdname future_imap
#' @export
future_iwalk <- function(.x, .f, ..., .options = future_options()) {
  .f <- purrr::as_mapper(.f, ...)
